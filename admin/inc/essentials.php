<?php 
  ...
  define('SITE_URL','http://localhost/kimochihotel-main/kimochihotel-main/');
 ...
 // define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/KimochiHotel/images/');
  define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/kimochihotel-main/kimochihotel-main/images/');
